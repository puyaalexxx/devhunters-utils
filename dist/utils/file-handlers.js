 ...
 * @return
 */
export function dhtuGetFileEntries(path, searchPaths, fileExtension, keySuffix = "") {
 ...
 * @return
 */
export async function dhtuFileExists(filePath) {
    try {
 ...
 * @return void
 */
export async function dhtuRemoveJsGeneratedFiles(pathsToClean) {
    try {
